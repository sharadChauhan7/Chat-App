...
function User({name="Sharad Chauhan", lastMsg="Jan 9, 2014"}) {
  return (
    <div className='flex h-16 border-b-2  items-center px-3 hover:bg-gray-200 transition ease-in-out delay-150 '>
